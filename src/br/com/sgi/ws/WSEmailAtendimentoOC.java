 ...
 * @author jairo.silva
 */
public class WSEmailAtendimentoOC {
    ...
    public void executar(String usuario, String senha) throws Exception {
        ...
        String url = "http://192.168.2.193:18080/sapiensweb/conector?SIS=CO&LOGIN=SID&ACAO=EXESENHA&NOMUSU=" + usuario.toLowerCase() + "&SENUSU=" + senha + "&PROXACAO=SID.SRV.REGRA&NUMREG=107";
