 ...
 * @author jairosilva
 */
public final class ManutencaoPeso extends InternalFrame {

    private UtilDatas utilDatas;
    private IntegrarPesos veioCampo;

    public ManutencaoPeso() {
        try {
            initComponents();
    ...
    public void setRecebePalavra(IntegrarPesos veioInput, String TIPO_PESAGEM, String PROCESSO, CargaRegistro cargaRegistro) throws Exception {
        this.veioCampo = veioInput;
        setTitle(ClientSettings.getInstance().getResources().getResource("Manutenção de Peso " + cargaRegistro.getNumerocarga()));
    ...
    private void validarPeso(String retorno) {
        if (retorno.equals("ERRO")) {
            ...
            if (veioCampo != null) {
                try {
                    veioCampo.ExcluirPeso(retorno, txtInfo.getValue().toString());
                } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jLabel13)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtInfo, javax.swing.GroupLayout.DEFAULT_SIZE, 134, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
